...
- if statements - used to create a branch in the code that tells the computer what to do if a specific condition is met.
- method - a way of grouping a set of processes to be used within the code
...
* [x][It's okay to ask questions](https://dev.to/mporam/its-okay-to-ask-questions-43hf)
* [x][Asking better questions](https://dev.to/josefine/asking-better-questions-2e2k)
* [x][Your Questions Are Dumb; Ask Them Anyway](https://dev.to/kathryngrayson/your-questions-are-dumb-ask-them-anyway-3cm6)
